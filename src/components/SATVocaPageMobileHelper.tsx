...
export function MobileStep2Modal({
  ...
  return (
    <Dialog open={step === 2} onOpenChange={(open) => !open && setStep(1)}>
      <DialogContent className="!max-w-[95vw] md:!max-w-[1400px] !w-[95vw] md:!w-[90vw] !h-[80vh] md:!h-[85vh] !bottom-auto !top-[10vh] md:!top-auto p-0 overflow-hidden flex flex-col [&>button]:hidden">
